...
export const T: Record<Lang, Record<string, string>> = {
  es: {
    ...
    homeSubtitle: "Centro de Identidad Digital",
    documents: "documentos",
    myDocuments: "Mis documentos",
    myPersonalDocs: "Mis documentos personales",
    recent: "Recientes",
    seeAll: "Ver todos",
    addFirst: "Agregá tu primer documento",
    addFirstDesc: "DNI, pasaporte, licencia, salud — todo en un lugar cifrado",
    noDocs: "Sin documentos aún",
    activeProtection: "Protección activa",
    encryptedBio: "Cifrado AES-256 · Biometría",
    infoSafe: "Tu información está segura",
    connectToNetwork: "Conectate a la red global",
    connectDesc: "Bancos, hospitales, aeropuertos y más",
    coverage: "Cobertura",
    protected: "Protegido",
    emptyDocCategory: "Sin documentos",
    ...
    // Business
    businessTitle: "Mi empresa",
    businessSubtitle: "Identidad empresarial y documentos",
    businessName: "Nombre comercial",
    businessLegalName: "Razón social",
    businessTaxId: "CUIT / Número fiscal",
    businessType: "Tipo de empresa",
    businessIndustry: "Rubro",
    businessFounded: "Fecha de fundación",
    ...
    addBusiness: "Registrar empresa",
    editBusiness: "Editar empresa",
    noBusiness: "Aún no registraste ninguna empresa",
    noBusinessSub: "Agregá tu empresa para gestionar su identidad digital",
    businessSaved: "Empresa guardada",
    businessDocType: "Tipo de documento",
    addBusinessDoc: "Agregar documento",
    businessDocTypes: "Estatuto,Inscripción,Balance,Contrato,Poder,Otro",
  ...
  en: {
    ...
    homeSubtitle: "Digital Identity Center",
    documents: "documents",
    myDocuments: "My documents",
    myPersonalDocs: "My personal documents",
    recent: "Recent",
    seeAll: "See all",
    addFirstDesc: "ID, passport, license, health — all in one encrypted place",
    encryptedBio: "AES-256 Encryption · Biometrics",
    connectDesc: "Banks, hospitals, airports and more",
    coverage: "Coverage",
    protected: "Protected",
    emptyDocCategory: "No documents",
    tapToAdd: "Tap to add",
    empresa: "Business",
    networkLocal: "Local",
    ...
    businessSubtitle: "Business identity and documents",
    businessName: "Trade name",
    businessLegalName: "Legal name",
    businessTaxId: "Tax ID / EIN",
    businessType: "Company type",
    businessIndustry: "Industry",
    businessFounded: "Founded date",
    ...
    addBusiness: "Register company",
    editBusiness: "Edit company",
    noBusiness: "No company registered yet",
    noBusinessSub: "Add your company to manage its digital identity",
    businessSaved: "Company saved",
    businessDocType: "Document type",
    addBusinessDoc: "Add document",
    businessDocTypes: "Articles,Registration,Balance sheet,Contract,Power of attorney,Other",
  ...
  pt: {
    ...
    homeSubtitle: "Central de Identidade Digital",
    documents: "documentos",
    myDocuments: "Meus documentos",
    myPersonalDocs: "Meus documentos pessoais",
    recent: "Recentes",
    seeAll: "Ver todos",
    addFirst: "Adicione seu primeiro documento",
    addFirstDesc: "RG, passaporte, habilitação, saúde — tudo em um lugar criptografado",
    noDocs: "Sem documentos ainda",
    activeProtection: "Proteção ativa",
    encryptedBio: "Criptografia AES-256 · Biometria",
    infoSafe: "Suas informações estão seguras",
    connectToNetwork: "Conecte-se à rede global",
    connectDesc: "Bancos, hospitais, aeroportos e muito mais",
    coverage: "Cobertura",
    protected: "Protegido",
    emptyDocCategory: "Sem documentos",
    ...
    businessTitle: "Minha empresa",
    businessSubtitle: "Identidade empresarial e documentos",
    businessName: "Nome comercial",
    businessLegalName: "Razão social",
    businessTaxId: "CNPJ / Número fiscal",
    businessType: "Tipo de empresa",
    businessIndustry: "Setor",
    businessFounded: "Data de fundação",
    ...
    businessDocs: "Documentos empresariais",
    addBusiness: "Registrar empresa",
    editBusiness: "Editar empresa",
    noBusiness: "Nenhuma empresa registrada ainda",
    noBusinessSub: "Adicione sua empresa para gerenciar sua identidade digital",
    businessSaved: "Empresa salva",
    businessDocType: "Tipo de documento",
    addBusinessDoc: "Adicionar documento",
    businessDocTypes: "Estatuto,Registro,Balanço,Contrato,Procuração,Outro",
    businessIdentity: "Identidade empresarial",
  },
};
